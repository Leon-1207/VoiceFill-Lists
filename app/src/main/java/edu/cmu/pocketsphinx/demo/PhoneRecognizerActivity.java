...
public class PhoneRecognizerActivity extends Activity implements
        RecognitionListener {
    ...
    private static class SetupTask extends AsyncTask<Void, Void, Exception> {
        WeakReference<PhoneRecognizerActivity> activityReference;

        SetupTask(PhoneRecognizerActivity activity) {
